...
-- Crear tabla intermedia producto-error (relación N a N)
...
CREATE TABLE lotes (
    ...
    estado VARCHAR(50) DEFAULT 'En proceso' -- Estados posibles: En proceso, Enviado a QA, Rechazado, etc.
);

-- Crear tabla intermedia lote-productos
